        ...
        if 'grantee' in data:
            ...
            if 'obj' in data:
                ...
                if old_perms:
                    ...
                    msg = """You must grant at least 1 permission for new \
                        users and groups"""
...
def view_permissions(request, obj, url, user_id=None, group_id=None,
    ...
    configured with a model and url.  It may also be customized by adding
    custom templates or changing the pk field.
            ...
            if form.update_perms():
                ...
                if form_user:
                    context = {'object': obj,
                               ...
                               'url': url}
                    return render(request, user_template,
                                  context)
                else:
                    context = {'object': obj, 'group': group,
                               'url': url}
    ...
    context = {'form': form, 'obj': obj, 'user_id': user_id,
               'group_id': group_id, 'url': url}
    return render(request, 'object_permissions/permissions/form.html',
                  context)
...
def view_obj_permissions(request, class_name, obj_id=None,
                         ...
                         row_template=
                         'object_permissions/permissions/object_row.html'):
    """
...
def all_permissions(request, id,
    ...
    context = {'persona': user_detail, 'perm_dict': repacked}
    return render(request, template, context)
