...
class Command(BaseCommand):
    option_list = BaseCommand.option_list + (
        ...
        make_option(
            ...
            help='Automatically include all \
            applications from INSTALLED_APPS'),
        ...
        make_option(
            '--verbose-names', '-n', action='store_true',
            dest='verbose_names',
            help='Use verbose_name of models and fields'),
        make_option('--language', '-L', action='store', dest='language',
                    help='Specify language used for \
                    verbose_name localization'),
        make_option(
            '--exclude-columns', '-x', action='store',
    ...
    help = ("Creates a GraphViz dot file for the specified app names. \
     You can pass multiple app names and they will all be combined into\
      a single model.  Output is usually directed to a dot file.")
    args = "[appname]"
