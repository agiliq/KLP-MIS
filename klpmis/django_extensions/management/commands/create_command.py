...
class Command(AppCommand):
    option_list = AppCommand.option_list + (
        ...
        make_option(
            ...
            default='Base',
            help='The base class used for implementation of this command.\
                 Should be one of Base, App, Label, or NoArgs'),
    )

    help = ("Creates a Django management command\
        directory structure for the given app name"
